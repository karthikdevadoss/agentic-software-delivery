...
TEST_EVIDENCE = {
    ...
    "java": {"total": 162, "passed": 162, "skipped": 0, "failed": 0,
             "skip_reason": "Counted from the GitHub Actions CI run (35781903501), where the Testcontainers-backed Postgres/Kafka tests run for real; on this Docker-less dev machine those tests skip",
             "as_of_commit": "e4c0b86"},

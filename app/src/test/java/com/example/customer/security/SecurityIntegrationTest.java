 ...
 * real JWT decoder -- proves every dimension PHASE 4 requires: no token,
 * malformed token, wrong signature, expired token, wrong issuer/audience,
 * wrong scope, and the positive valid-token case. Also proves the demo
 * issuer structurally cannot grant anything beyond its fixed business
 * scope set.
 */
...
class SecurityIntegrationTest {
    ...
    void protectedEndpoint_withWrongSignature_returns401() {
        ...
        DemoJwtIssuer forgedIssuer = new DemoJwtIssuer(
                ...
                "agentic-delivery-customer-app-demo-issuer",
                "customer-app",
                900);
    ...
    void publicEndpoints_remainReachableWithNoToken() {
        ...
        assertThat(restTemplate.getForEntity(url("/v3/api-docs"), String.class).getStatusCode()).isEqualTo(HttpStatus.OK);
    }

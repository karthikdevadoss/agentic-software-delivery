 ...
 * credential verification. Proves known public username/password pairs
 * genuinely authenticate, a wrong password genuinely fails, and the
...
class DemoLoginControllerIntegrationTest {
    ...
    // anything this server does -- same reasoning as the monolith's
